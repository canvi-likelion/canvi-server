...
public enum BaseResponseStatus {
    ...
    /** client error - 4xx */
    INVALID_AUTH_CODE(false, HttpStatus.BAD_REQUEST.value(), "인증번호가 올바르지 않습니다."),
    ...
    EMAIL_RESEND_TOO_SOON(false, HttpStatus.TOO_MANY_REQUESTS.value(), "이메일 재전송은 5분 후에 가능합니다."),
